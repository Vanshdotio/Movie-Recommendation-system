  ...
  return (
    <>
      <Swiper
        ...
        className="mySwiper h-screen md:h-screen w-full md:w-full cursor-grab active:cursor-grabbing"
      >
        {/* ===== Slide 1 ===== */}
        <SwiperSlide>
          <div className="relative text-white overflow-hidden w-full h-screen font-[Inter]">
            ...
            <div className="absolute w-full flex flex-col bottom-10 left-0 ml-6 gap-5">
              <img
                className="h-40 w-54"
              ...
              <div className="items-center w-full flex justify-between pr-10">
                <button className="gradient-btn p-2 w-70 md:w-80 my-5 font-bold  rounded-sm items-center justify-center flex gap-2 cursor-pointer">
                <svg
              ...
              <button
                ...
                className="  bottom-10 right-6 cursor-pointer bg-white/60 p-2 rounded-full text-white hover:bg-white/30 transition"
              >
                {mutedStates[0] ? (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
